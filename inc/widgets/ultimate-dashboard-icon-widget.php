...
function udb_icon_widget() { ?>
	...
	<div class="udb-metabox-wrapper udb-icon-wrapper active">
		...
		<div class="udb-metabox-section">
			...
			<h3><?php _e( 'Icon', 'ultimatedashboard' ); ?></h3>
			...
			<div id="udb-icon-header">
				<h4><?php _e( 'Search', 'ultimatedashboard' ); ?> <i class="fa fa-search"></i></h4>
			</div>

			<div class="ca-accordion">

				<!-- WordPress Dashicons -->
				<h4 class="ca-accordion-title"><?php _e( 'WordPress Dashicons', 'ultimatedashboard' ); ?></h4>
				...
				<ul>
					...
					<li>
						...
						<h4><?php _e( 'Admin Menu', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Welcome Screen', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Post Formats', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Media', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Image Editing', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Tiny MCE', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Posts Screen', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Sorting', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Social', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'WordPress.org specific', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Products', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Taxonomies', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Widgets', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Notifications', 'ultimatedashboard' ); ?></h4>
					...
					<li>
						...
						<h4><?php _e( 'Misc', 'ultimatedashboard' ); ?></h4>
			...
			<div class="ca-accordion">
				...
				<!-- Font Awesome -->
				<h4 class="ca-accordion-title"><?php _e( 'Font Awesome', 'ultimatedashboard' ); ?></h4>

				<div class="udb-icon-list ca-accordion-content">

					<ul>
						<li>
							<h4><?php _e( 'Font Awesome Icons', 'ultimatedashboard' ); ?></h4>
		...
		<div class="udb-metabox-section">
			...
			<h3><?php _e( 'Link', 'ultimatedashboard' ); ?></h3>
			...
			<table class="form-table">
				<tbody>
					<tr>
						<th>
							<label for="udb-link"><?php _e( 'URL', 'ultimatedashboard' ); ?></label><br>
					...
					<tr>
						<th>
							<label for="udb-link-target"><?php _e( 'Target', 'ultimatedashboard' ); ?><br>
							<span class="description"><?php _e( 'Open link in a new tab.', 'ultimatedashboard' ); ?></span>
							</label>
						</th>
						<td>
