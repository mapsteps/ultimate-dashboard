...
return function ( $module ) {
	...
	if ( $module->screen()->is_plugin_onboarding() ) {
		...
		wp_enqueue_style( 'tiny-slider', ULTIMATE_DASHBOARD_PLUGIN_URL . '/modules/plugin-onboarding/assets/css/tiny-slider.css', array(), ULTIMATE_DASHBOARD_PLUGIN_VERSION );
