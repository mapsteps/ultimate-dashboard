...
<div class="field" data-show-if-field="udb_menu_type" data-show-if-value="parent">
	...
	<div class="control">
		<input type="text" class="icon-picker is-full" data-width="100%" name="udb_menu_icon" id="udb_menu_icon" value="<?php echo esc_attr( $menu_icon ? $menu_icon : 'dashicons dashicons-admin-generic' ); ?>" placeholder="dashicons dashicons-admin-generic" />
	</div>
</div>
