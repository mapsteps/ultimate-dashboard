...
$fields_bg_color           = isset( $login['fields_bg_color'] ) ? $login['fields_bg_color'] : 'transparent';
$fields_bg_color_focus     = isset( $login['fields_bg_color_focus'] ) ? $login['fields_bg_color_focus'] : 'transparent';
