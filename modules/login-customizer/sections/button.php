...
$wp_customize->add_control(
	new Udb_Customize_Range_Control(
		...
		array(
			...
			'label'       => __( 'Button Height', 'ultimatedashboard' ),
			'input_attrs' => array(
				'min'  => 20,
				'max'  => 80,
				'step' => 1,
...
$wp_customize->add_control(
	new Udb_Customize_Range_Control(
		...
		array(
			...
			'label'       => __( 'Button Side Padding', 'ultimatedashboard' ),
			'input_attrs' => array(
				'min'  => 10,
				'max'  => 60,
				'step' => 1,
...
$wp_customize->add_control(
	new Udb_Customize_Range_Control(
		...
		array(
			...
			'label'       => __( 'Button Border Radius', 'ultimatedashboard' ),
			'input_attrs' => array(
				'min'  => 0,
				'max'  => 50,
				'step' => 1,
...
$wp_customize->add_control(
	new Udb_Customize_Color_Control(
		...
		'udb_login[button_text_color]',
		array(
			'label'    => __( 'Button Text Color', 'ultimatedashboard' ),
			'section'  => 'udb_login_customizer_button_section',
...
$wp_customize->add_control(
	new Udb_Customize_Color_Control(
		...
		'udb_login[button_text_color_hover]',
		array(
			'label'    => __( 'Button Text Color (Hover)', 'ultimatedashboard' ),
			'section'  => 'udb_login_customizer_button_section',
...
$wp_customize->add_control(
	new Udb_Customize_Color_Control(
		...
		'udb_login[button_bg_color]',
		array(
			'label'    => __( 'Button Background Color', 'ultimatedashboard' ),
			'section'  => 'udb_login_customizer_button_section',
...
$wp_customize->add_control(
	new Udb_Customize_Color_Control(
		...
		'udb_login[button_bg_color_hover]',
		array(
			'label'    => __( 'Button Background Color (Hover)', 'ultimatedashboard' ),
			'section'  => 'udb_login_customizer_button_section',
