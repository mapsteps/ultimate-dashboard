...
class Tool_Module extends Base_Module {
	...
	public function submenu_page() {
		add_submenu_page( 'edit.php?post_type=udb_widgets', 'Tools', 'Tools', apply_filters( 'udb_settings_capability', 'manage_options' ), 'udb_tools', array( $this, 'submenu_page_content' ) );
	}
